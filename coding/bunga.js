;(function (window) {
    ...
    let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'SELAMAT ULANG TAHUN YA', 'SELALU BAHAGIAA', 'DIMUDAHKAN REZEKINYA', 'PANJANG UMUR', 'SEMOGA KETERIMA DI PTN YANG KAMU MAU', 'TAU GA?', 'BESOK HARI SENIN', 'KEKNYA DARI KEMAREN GA SEMANGAT', 'KENAPAA??', 'CERITA DONG', 'EMMMMMM', 'BJIR KADO W NNTI BAGUS G Y', 'MOGA SUKA', 'YAUDAH DEH', 'SEGITU DLU', 'OKENG', 'BYE', 'OH IYA', 'OH IYA SEHAT NYA KETINGGALAN', 'UDH YAA', 'PI BET DEYYY🍰']
